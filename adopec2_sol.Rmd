...
Para nuestro estudio vamos a tomar `r params$samples` muestras al azar de cada uno de los grupos. Para hacerlo sin tener que dividir el data frame nos valemos de la función `ddply`, que permite aplicar una función a distintos conjuntos de un data frame, y crea un data frame de salida con las respuestas. Así la usamos para generar un data frame con el número de muestras deseadas para cada grupo.  
