...
En la Figura 3 podemos ver el `log2` de fold change para cada uno de los resultados. Los puntos azules son aquellos que tienen un valor representativo de p-adjust, y los triángulos en los bordes muestran dónde los puntos salen de rango.  
...
kable_styling(knitr::kable(head(res_ELIvNIT[,c(5,6,7)],10), booktabs = TRUE,
                            caption = 'ELIvNIT'),font_size = 10, 
              bootstrap_options = c("striped", "condensed", digits = 20,  full_width = F))
kable_styling(knitr::kable(head(res_SFIvNIT[,c(5,6,7)],10), booktabs = TRUE,
                            caption = 'SFIvNIT'),font_size = 10, 
              bootstrap_options = c("striped", "condensed", digits = 20,  full_width = F))
kable_styling(knitr::kable(head(res_ELIvSFI[,c(5,6,7)],10), booktabs = TRUE,
...
kk <- enrichKEGG(gene         = topGenes_SFIvNIT$entrez,
                 organism     = 'hsa',
                 pvalueCutoff = 0.05)
